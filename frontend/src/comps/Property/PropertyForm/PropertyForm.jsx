...
//   useEffect(() => {
//     fetchCounties().then(counties => setCounties(counties))
//   }, [])
...
//     >
//       <Typography variant="h5">Post Your Property</Typography>
...
//             setFormData({ ...formData, locality: '' }) // i must reset the locality each time a new county is selecte
//           }}
//           required
//         >
//           {counties.map((county) => (
